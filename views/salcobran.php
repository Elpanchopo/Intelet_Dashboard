<?php
  ...
  require_once __DIR__ . '/../models/salcobrand_fx.php';
  include 'header.php';
?>
...
<main>
  ...
  <div class="card-deck" style="margin-right: 0px !important;margin-left: 0px !important;margin-top: 15px !important;">
    ...
    <div class="card">
      ...
      <div class="card-body">
      <h4 class="card-title"> <?php echo $cardsArr['c4']; //Imprimo el valor de c1 del arreglo
      ?></h4>
        ...
        <div class="col-12">
            ...
            <div class="card text-black" style=" color: #343a40!important;">
              <div class="card-body">
                ...
                <script>
                  var datos = <?php getGestionesEjecutivosHora7(); ?> ;
      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="table-responsive">
            ...
            <?php 
              $json_data = getTablaGestionesEjecutivosHora7(); // Traigo el json de la consulta
    ...
    <div class="dropdown-content" style="background-color: white!important;">
        ...
        <div class="col-12">
            ...
            <div class="card text-black" style="color: #343a40!important;">
              ...
              <div class="card-body">
                ...
                <script>
                  var datos = <?php getTipoGestionesEjecutivos7(); ?>;
                  // parametros del constructor:
                  //datos, etiquetas, valores, id canvas, titulo del grafico, eje x, eje y
      ...
      <div class="row">          
        <div class="col-12">
          ...
          <?php 
              $json_data = getTablaTGDiarioTotal7(); // Traigo el json de la consulta
              $datos = json_decode($json_data, true);

              $json_data = getTablaTGDiarioSumTotal7(); // Traigo el json de la consulta totales por TG
