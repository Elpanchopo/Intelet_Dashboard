<?php
  ...
  require_once __DIR__ . '/../models/rutaMaipo_fx.php';
  include 'header.php';
?>
        ...
        <div class="col-12">
            ...
            <div class="card text-black" style=" color: #343a40!important;">
              <div class="card-body">
                ...
                <script>
                  var datos = <?php getGestionesEjecutivosHora6(); ?> ;
      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="table-responsive">
            ...
            <?php 
              $json_data = getTablaGestionesEjecutivosHora6(); // Traigo el json de la consulta
    ...
    <div class="dropdown-content" style="background-color: white!important;">
        ...
        <div class="col-12">
            ...
            <div class="card text-black" style="color: #343a40!important;">
              ...
              <div class="card-body">
                ...
                <script>
                  var datos = <?php getTipoGestionesEjecutivos6(); ?>;
                  // parametros del constructor:
                  //datos, etiquetas, valores, id canvas, titulo del grafico, eje x, eje y
      ...
      <div class="row">          
        <div class="col-12">
          ...
          <?php 
              $json_data = getTablaTGDiarioTotal6(); // Traigo el json de la consulta
              $datos = json_decode($json_data, true);

              $json_data = getTablaTGDiarioSumTotal6(); // Traigo el json de la consulta totales por TG
